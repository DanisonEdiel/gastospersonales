  ...
  <html lang="en-es">
    ...
    <body>
      <form v-if="mostrarFormulario">
        <div class="container">
          ...
          <div class="container mt-5">
            <h2 class="text-center mb-4">
              Detalle de Ingresos del Colaborador
            </h2>
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      @input="
                        validateInput('comisionesMandatoVeces', null, 12)
                      "
                      type="text"
                      placeholder="-"
                    />
                ...
                <tr>
                  <td colspan="4">
                    Si tienes o has tenido otro empleador durante el año 2024,
                    es decir constas bajo otra relación de dependencia:
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      @input="
                        validateInput('utilidadesEmpleadorVeces', null, 1)
                      "
                      type="text"
                      placeholder="-"
                    />
          ...
          <div class="container mt-5">
            ...
            <table class="table table-bordered">
              ...
              <tbody class="text-right">
                ...
                <tr>
                  <td>
                    Máximo en Gastos personales para aplicar en el año 2024
                    según sus cargas
                  </td>
          ...
          <div class="container mt-5">
            <h3>
              RESPALDOS PARA LOS GASTOS DECLARADOS COMO DEDUCIBLES PARA LA
              REBAJA MÁXIMA DE IMPUESTO A LA RENTA
            </h3>
            <table class="table table-bordered">
              <thead class="table-header">
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Impuestos Prediales de un único inmueble para vivienda
                  </td>
                ...
                <tr>
                  <td>
                    PAGO SERVICIOS BASICOS : Agua, gas, luz, teléfono
                    convencional
                  </td>
                  <td>De un único bien inmueble para vivienda</td>
                  <td>Factura</td>
                  ...
                  <td>
                    <input
                      ...
                      @input="
                        validateInput('pagoServiciosVeces', null, 1000000)
                      "
                      type="text"
                      placeholder="-"
                    />
                ...
                <tr>
                  ...
                  <td>
                    ...
                    instituciones aprobadas por el Ministerio de Educación o en
                ...
                <tr>
                  ...
                  <td>
                    Servicios prestados por centros infantiles autorizados
                  </td>
                  <td>Factura</td>
                  <td>
                    <input
                ...
                <tr>
                  ...
                  <td>
                    Pensiones alimenticias respaldadas en una resolución
                    judicial. Ante la autoridad competente.
                  </td>
                ...
                <tr>
                  <td>RESTAURANTES</td>
                  <td>
                    Compra de alimentos en locales de alimentos preparados.
                  </td>
                  <td>Factura</td>
                  <td>
                    <input
                ...
                <tr>
                  <td>HOSPEDAJE</td>
                  <td>
                    Gastos por alquiler de habitaciones o un bien inmueble
                    dentro del ECUADOR con el objetivo de realizar turismo local
                  </td>
                  <td>Factura</td>
                  <td>
                    <input
                ...
                <tr>
                  ...
                  <td>
                    ...
                    registrados en el Consejo Nacional de Educación Superior.
                  </td>
                  <td>Factura</td>
                  <td>
                    <input
                ...
                <tr>
                  ...
                  <td>
                    Clínicas, hospitales, laboratorios y farmacias reconocidas
        ...
        <div
          v-if="shouldDisableGastos()"
          class="alert alert-danger"
          role="alert"
        >
          No puedes avanzar porque los campos obligatorios están vacíos o
          valores sobrepasan el límite que seleccionó: {{ gastosPersonales }}
        </div>
      </form>
      <div v-else id="content" class="container">
        <!-- Tu tabla aquí -->
        <table class="table-custom">
          <thead>
            <tr class="p-doce">
              <th colspan="4" class="header-large">
                SRI<br />FORMULARIO SRI-GP
              </th>
              <th colspan="7" class="header-large">
                DECLARACIÓN DE GASTOS PERSONALES A SER UTILIZADOS POR EL
                EMPLEADOR EN EL CASO DE INGRESOS EN RELACIÓN DE DEPENDENCIA
              </th>
            </tr>
          </thead>
          <tbody>
        ...
        <table class="table-custom">
          <thead>
            <tr class="p-diez">
              <td colspan="7">
                <strong
                  >Información / Identificación del empleado contribuyente (a
                  ser llenado por el empleado)</strong
                >
              </td>
            </tr>
          </thead>
        ...
        <table class="table-custom">
          <tbody>
            ...
            <tr>
              <td colspan="2" class="p-ocho">
                <strong
                  ...
                  (106+107+108+109+110+111)</strong
                >
              </td>
            ...
            <tr>
              <td colspan="2" class="p-ocho">
                <strong
                  >TRABAJADOR O SUS CARGAS FAMILIARES CON ENFERMEDAD
                  CATASTRÓFICA
                </strong>
              </td>
            ...
            <tr>
              <td colspan="4" class="p-ocho">
                ...
                DOS O MÁS empleadores, presentará este informe al empleador con
                el que perciba mayores ingresos, el que efectuará la retención
                ...
                ejercicio económico. Al resultado obtenido se le restará la
                rebaja por la proyección de gastos personales, según los límites
                establecidos en la Ley, y se dividirá para 12, para determinar
                la alícuota mensual a retener por concepto de Impuesto a la
                Renta. Cuando la relación laboral inicie en un mes distinto de
                enero el resultado deberá dividirse para el número de meses que
                resten para finalizar el periodo. Una copia certificada, con la
                respectiva firma y sello del empleador, será presentada a los
                demás empleadores para que se abstengan de efectuar retenciones
                sobre los pagos efectuados por concepto de remuneración del
            ...
            <tr>
              <td colspan="4" class="p-ocho">
                3.- Se considerarán como cargas familiares a los padres, cónyuge
                o pareja en unión de hecho e hijos hasta los 21 años o con
                ...
                caso, dos o más contribuyentes podrán considerar a la misma
                carga familiar para la rebaja por gastos personales.
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="table-custom">
          ...
          <tbody>
            <tr class="p-ocho">
              ...
              <td rowspan="2">117</td>
              <td>
                RAZON SOCIAL, DENOMINACIÓN O APELLIDOS Y NOMBRES COMPLETOS
              </td>
            </tr>
...
export default {
  ...
  methods: {
    ...
    shouldDisableCampos() {
      return (
        !this.cedulaRuc || !this.nombre || !this.anio || !this.mes || !this.dia
      );
    },
    enviarFormulario() {
